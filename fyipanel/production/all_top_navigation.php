          ...
          <div class="nav_menu">
            <nav> 
              ...
              <ul class="nav navbar-nav navbar-right" style="width: 70%" > 
                ...
                <?php }  ?>   
                    <li><a href="all_cpanel.php" >All</a></li> 
                      ...
                      <li><a  href="<?php echo $fun_of_user; ?>">English</a></li>
                      ...
                      <li><a  href="../../japanese/fyipanel/production/<?php echo $fun_of_user; ?>">Japanese</a></li>
                ...
                <li  >
                  <a href="all_cpanel.php" class="user-profile dropdown-toggle"  >
