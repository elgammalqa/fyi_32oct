        ...
        while ($data = $query->fetch())
	        ...
	        return  $nbpages ;
             ...
             public static  function nbrssfeeds(){
                ...
                //////// 
                public function countries_authorized(){
                $tab = array();      
                include("fyipanel/views/connect.php");
                $query=$con->query("SELECT * FROM rss_sources where country not in (select distinct country from user_sources) ");
                while ($data = $query->fetch())
                        $tab[] = $data;
                                return $tab;
               }
            
                public function countries_Unauthorized(){
                $tab = array();      
                include("fyipanel/views/connect.php");
                $query=$con->query("SELECT distinct country FROM user_sources ");
                while ($data = $query->fetch())
                        $tab[] = $data;
                                return $tab;
               }
