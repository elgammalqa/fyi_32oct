...
insert into account values(1,"noreply@chatsrun.com","@ftre34#kl987La","mail.chatsrun.com",465,20,"ssl","https://www.fyipress.net/hebrew");



/* il */
 insert into footer values(1,"אנחנו אתר מידע ... אנחנו שייכים לרשת החברתית (chatsrun) ... אנחנו לא מאפשרים את הבוז של כל דת, גזע או צבע ברשת שלנו ... אנחנו תמיד שמחים עם ההצעות שלך", 
 ...
 insert into rss_sources values  
  (1,"haaretz","Sports",1,"Israel"), (2,"haaretz","News",1,"Israel"), (3,"haaretz","General Culture",1,"Israel"), 
  (4,"themarker","Technology",1,"Israel"),
  (5,"globes","News",1,"Israel"), (6,"globes","Technology",1,"Israel"),
                                (7,"Geektime","Technology",1,"United States"),
                                (8,"inn","News",1,"Israel"),
                                (9,"epochtimes","News",1,"United States"),
                                (10,"mako","News",1,"Israel"),
                                (11,"mako","General Culture",1,"Israel"),
                                (12,"mako","Arts",1,"Israel"),
                                (13,"mako","Sports",1,"Israel"), 
                                (14,"mako","Technology",1,"Israel");

  /*  v2 7 8  15-30 */
  DELETE FROM rss_sources WHERE id in (7,8);
  insert into rss_sources values  
  (7,"globes","General Culture",1,"Israel"),
  (8,"Israel Hayom","News",1,"Israel"),
  (15,"Davar news","News",1,"Israel"), 
  (16,"hazofe","News",1,"Israel"),  
  (17,"calcalist","News",1,"Israel"),   
  (18,"calcalist","Sports",1,"Israel"), 
  (19,"calcalist","Technology",1,"Israel"), 
  (20,"themarker","News",1,"Israel"),
  (21,"ynet","News",1,"Israel"),  
  (22,"ynet","Sports",1,"Israel"), 
  (23,"ynet","Technology",1,"Israel"), 
  (24,"ynet","General Culture",1,"Israel"), 
  (25,"HWzone","Technology",1,"Israel"), 
  (26,"debka","News",1,"Israel"), 
  (27,"news-israel","News",1,"Israel"), 
  (28,"srugim","News",1,"Israel"), 
  (29,"93fm","News",1,"Israel"), 
  (30,"TGspot","Technology",1,"Israel");
  


/* 
        // ne pas pris en charge 2018 pubdate
...
insert into links(1,'https://www.fyipress.net/hebrew','https://www.fyipress.net/hebrew');