...
class userModel 
{
    ...
    public function add_user()
    {
        ...
        include("../views/connect.php");
       if(!$con->exec('INSERT INTO users VALUES ("' . $this->Email . '","' . $this->First_name . '","' . $this->Last_name . '","' . $this->Gender . '","' . $this->Photo . '","' . $this->Password . '","' . $this->Function . '",0,' . $this->isEmailConfirmed . ',"' . $this->token . '","")')) $e=false;
        ...
        if(!$con->exec('INSERT INTO users VALUES ("' . $this->Email . '","' . $this->First_name . '","' . $this->Last_name . '","' . $this->Gender . '","' . $this->Photo . '","' .
        $this->Password . '","' . $this->Function . '",0,' . $this->isEmailConfirmed . ',"' . $this->token . '","")')) $e=false; 
            return $e;
    }
