          ...
          <div class="nav_menu">
            <nav> 
              ...
              <ul class="nav navbar-nav navbar-right" style="width: 80%" > 
                ...
                <?php } ?>      
                      <li><a   href="<?php echo $fun_of_user; ?>">Arabic</a></li> 
             ...
             <?php   if(usermodel::isMobile()){ ?>
                   ...
                   <img src="../../../images/ar.png" style="max-width: none;width: 30px;"  >
                </li>
                <?php }else{  ?>
                   <li style="margin-right:40%;padding-top: 8px;"  style="float: left !important;" >
                  <h4 style="color: #2A3F54;">اللغة العربية </h4>
                </li>
                <?php }  ?>
