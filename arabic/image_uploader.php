 ...
 ***************************************************/
$accepted_origins = array("http://localhost", "http://127.0.0.1", "https://www.fyipress.net", "https://www.fyipress.net");
...
if (is_uploaded_file($temp['tmp_name'])){
    ...
    */
    ...
    $new_name = time() . mt_rand(11111,99999). '.'.$ext;
    ...
    echo json_encode(array('location' => $new_name));
} else {
