...
<?php
	...
	if (!isset($_GET['email']) || !isset($_GET['token'])) {
	  ...
	  <br><br><br><br>  
	  <span id="pl1" style="font-size: 30px; " > آپ کا ای میل کی تصدیق کی گئی ہے! آپ کا پاس ورڈ ہے 
	  	<span style="color: green" >
	  		<input style="font-size: 25px; " value="<?php echo $newPassword; ?>"> </span> 
	  </span>
	   <br><br> 
	   <span  style="font-size: 30px ; padding-left: 30%">
	         <a target="_blank" href="fyipanel/production/index.php">لاگ ان کرنے کے لئے یہاں کلک کریں</a>
	   </span>  
	<?php	} else{
			redirect();
		}
