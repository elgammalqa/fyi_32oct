   ...
   public static function getgeoplugin_countryCode($d1){ 
        ...
        public function add_user(){
          try{
            //ur 
            include("../views/connect.php");
            $con->exec('INSERT INTO users VALUES ("'.$this->Email.'","'.$this->First_name.'","'.$this->Last_name.'","'.$this->Gender.'","'.$this->Photo.'","'.$this->Password.'","'.$this->Function.'",0,'.$this->isEmailConfirmed.',"'.$this->token.'","'.$this->Phone.'","'.$this->Phone.'")');
            //arabic
